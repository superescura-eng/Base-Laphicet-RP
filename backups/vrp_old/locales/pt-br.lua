Locales["pt-br"] = {
    ...
    ["noammo"] = "Munição insuficiente!",
    ["gave_item"] = "Entregando %sx %s para %s",
    ["received_item"] = "Recebeu %sx %s de %s",
    ["gave_weapon"] = "Entregando %s para %s",
    ["gave_weapon_ammo"] = "Entregando ~o~%sx %s para %s a %s",
    ["gave_weapon_withammo"] = "Entregando %s com ~o~%sx %s para %s",
    ["gave_weapon_hasalready"] = "%s já possui um %s",
    ["gave_weapon_noweapon"] = "%s não possui essa arma",
    ...
    ["received_weapon_hasalready"] = "%s tentou lhe dar um %s, mas você já tem essa arma",
    ["received_weapon_noweapon"] = "%s tentou lhe dar munição para um %s, mas você não possui essa arma",
    ["gave_account_money"] = "Dando $%s (%s) para %s",
    ["received_account_money"] = "Recebeu $%s (%s) de %s",
    ["amount_invalid"] = "Quantidade inválida",
    ["players_nearby"] = "Nenhum jogador por perto",
    ["ex_inv_lim"] = "Não pode realizar ação, excedendo o peso máximo de %s",
    ["imp_invalid_quantity"] = "Não pode realizar ação, a quantidade é inválida",
    ["imp_invalid_amount"] = "Não pode realizar ação, o valor é inválido",
    ["threw_standard"] = "Jogando %sx %s",
    ["threw_account"] = "Jogando $%s %s",
    ["threw_weapon"] = "Jogando %s",
    ["threw_weapon_ammo"] = "Jogando %s com ~o~%sx %s",
    ["threw_weapon_already"] = "Você já possui essa arma",
    ["threw_cannot_pickup"] = "Inventário cheio, não pode pegar!",
    ...
    -- Salário
    ["received_salary"] = "Você recebeu: $%s",
    ["received_help"] = "Você recebeu seu cheque assistencial: $%s",
    ["company_nomoney"] = "A empresa onde você trabalha não tem dinheiro para pagar seu salário",
    ["received_paycheck"] = "Recebeu pagamento",
    ["bank"] = "Banco Maze",
    ["account_bank"] = "Banco",
    ["account_black_money"] = "Dinheiro Sujo",
    ["account_money"] = "Dinheiro Vivo",

    -- Comandos
    ["command_bring"] = "Trazer jogador até você",
    ["command_car"] = "Gerar um veículo",
    ["command_cardel"] = "Remover veículos próximos",
    ["command_repair"] = "Reparar seu veículo",
    ...
    ["command_giveaccountmoney"] = "Dar dinheiro para uma conta específica",
    ["command_removeaccountmoney"] = "Remover dinheiro de uma conta específica",
    ["command_giveitem"] = "Dar item a um jogador",
    ["command_giveweapon"] = "Dar arma a um jogador",
    ["command_goto"] = "Teleportar-se para um jogador",
    ["command_kill"] = "Matar um jogador",
    ["command_save"] = "Forçar salvamento de dados de um jogador",
    ["command_saveall"] = "Forçar salvamento de dados de todos os jogadores",
    ["command_setaccountmoney"] = "Definir dinheiro dentro de uma conta específica",
    ["command_setcoords"] = "Teleportar para coordenadas específicas",
    ["command_setjob"] = "Definir emprego de um jogador",
    ["command_setgroup"] = "Definir grupo de permissões de um jogador",
