...
if Config.EnableNitro then
    ...
    RegisterNetEvent('hud:SetupNitro')
    AddEventHandler('hud:SetupNitro', function()
        ...
        if IsPedSittingInAnyVehicle(playerPed) then
            ...
            if vehicle ~= nil and DoesEntityExist(vehicle) and IsPedOnFoot(playerPed) then
                ...
                Citizen.CreateThread(function()
                    ...
                    TriggerServerEvent('hud:RemoveItem',Config.NitroItem, 1)
                    TriggerServerEvent('hud:InstallNitro', GetVehicleNumberPlateText(vehicle))
                end)
            else
    ...
    RegisterNetEvent('hud:UpdateNitroData')
    AddEventHandler('hud:UpdateNitroData', function(nitroData)
        nitro = nitroData
                ...
                if GetPedInVehicleSeat(playerVeh, -1) == playerPed then
                    while isPressing do
                        ...
                        if tonumber(nitro[GetVehicleNumberPlateText(playerVeh)]) <= 0 then
                            ...
                            TriggerServerEvent('hud:UpdateNitro', GetVehicleNumberPlateText(playerVeh), nitro[GetVehicleNumberPlateText(playerVeh)])
                            break
