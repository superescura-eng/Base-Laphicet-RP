...
local function handleUpgrade(warehouseId, upgradeType)
    ...
    EventHandlerId = AddEventHandler('warehouse:receiveUpgradeInfo', function(currentSlots, currentWeight)
        ...
        options = {
            {
                ...
                onSelect = function()
                    TriggerEvent('ox_inventory:openInventory', 'stash', {id = 'warehouse_' .. warehouseId, name = 'Armazém'})
                end
            }
        }
    })
