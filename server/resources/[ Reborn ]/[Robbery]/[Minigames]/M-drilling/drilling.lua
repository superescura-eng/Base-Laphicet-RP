...
Drilling.HandleControls = function()
    ...
    elseif IsControlPressed(0, 32) then -- W key
        Drilling.DrillPos = math.min(1.0, Drilling.DrillPos +
            (0.06 * GetFrameTime() / (math.max(0.1, Drilling.DrillTemp) * 10)))
    ...
    if Drilling.DrillPos >= 0.29 and Drilling.DrillPos <= 0.305 or Drilling.DrillPos >= 0.50 and Drilling.DrillPos <=
